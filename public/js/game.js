...
function intro() {
	var playButton = document.getElementById('titleScreen');
	...
	soundButton.onclick = function() {
		if (!game.sound) {
			...
			this.className = "turn-off";
		}
		else {
			game.sound = false;
			this.innerHTML = "Turn on sound";
			this.className = "turn-on";
		}
	};
}
